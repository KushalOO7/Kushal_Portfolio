  ...
  <Element name="home-section" className='grid grid-cols-1 w-full h-screen gap-7 px-5 place-items-center'>
      <div className="w-full h-full flex flex-col-reverse lg:px-10 lg:flex-row justify-center items-center gap-5 lg:gap-10">
        <div className='leading-7 flex flex-col'>
          ...
          <div className='text-5xl text-primary-blue mt-1 font-primaryMedium'>Kushal Dath Mogalraj</div>
          ...
          <div className='text-white text-md mt-5'>
            <span className='break-words'>I am an AI Developer and Machine Learning Engineer 
              specializing in building scalable, production-ready systems. With an M.Tech 
              in Machine Learning and AI, I have extensive experience in end-to-end development, 
              from designing model architectures to cloud deployment on AWS. 
              My professional work includes developing real-time face recognition systems and 
              implementing AI-powered chatbots utilizing LLMs and LangChain.
            </span>
          </div>

          <div className='flex justify-start items-start gap-3 mt-5'>
            <a className='text-white border-2 border-[#1f1f1f] rounded-full size-14 flex justify-center items-center hover:border-slate-300' href="https://www.linkedin.com/in/kushaldath/" target='_blank' >
              <Linkedin size={25} strokeWidth='1px' fill='white' />
            </a>
            <a href="https://github.com/KushalOO7" target='_blank' className='text-white border-2 border-[#1f1f1f] hover:border-slate-300 rounded-full size-14 flex justify-center items-center' >
              <Github size={25} strokeWidth='1px' fill='white' />
            </a>
          
            <a href="https://x.com/KMogalraj" target='_blank' className='text-white border-2 border-[#1f1f1f] rounded-full hover:border-slate-300 size-14 flex justify-center items-center' >
              <Twitter size={25} strokeWidth='1px' fill='white' />
            </a>

            <a href="Kushal_Mogalraj_Resume.pdf" download="Kushal Mogalraj Resume"><ShimmerButton shimmerSize={'0.09em'} className='py-5'><span className='font-primaryMedium leading-none tracking-tight'>Checkout Resume</span></ShimmerButton></a>
        </div>
      </div>
      <img className='size-80 border-2 object-cover rounded-full' src={mypic} alt="kushal Image"/>
    </div>
  </Element>
